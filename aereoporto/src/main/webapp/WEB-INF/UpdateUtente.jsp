				...
				<form action="UpdateUtente" method="post">
					...
					<div class="form-group">
						<label for="flightNumber">Numero del Volo</label> <input
							...
							name="flightNumber" placeholder="Inserisci il numero del volo">
					</div>
					<div class="form-group">
						<label for="date">Data del Volo</label> <input type="date"
							class="form-control" id="date" name="date">
					</div>
					<div class="form-group">
						<label for="destination">Destinazione</label> <input type="text"
